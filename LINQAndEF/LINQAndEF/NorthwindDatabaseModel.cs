namespace LINQAndEF
{
	...
	public partial class NorthwindDatabaseModel : DbContext
	{
		public NorthwindDatabaseModel()
			: base("name=NorthwindDatabaseModel")
		{
		}
		...
		public virtual ISet<Supplier> Suppliers { get; set; }
